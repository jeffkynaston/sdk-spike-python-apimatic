...
class PaymentMethodsResponse(object):
    ...
    """Implementation of the 'Payment Methods Response' model.

    TODO: type model description here.

    Attributes:
        data (list of PaymentMethod): TODO: type description here.
    ...
    def __init__(self,
                 data=None,
                 pagination=None):
        """Constructor for the PaymentMethodsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [PaymentMethod.from_dictionary(x) for x in dictionary.get('data')]
