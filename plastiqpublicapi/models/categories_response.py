...
"""
from plastiqpublicapi.models.category import Category
from plastiqpublicapi.models.pagination_object import PaginationObject


class CategoriesResponse(object):

    """Implementation of the 'Categories Response' model.

    TODO: type model description here.

    Attributes:
        data (list of Category): TODO: type description here.
    ...
    def __init__(self,
                 data=None,
                 pagination=None):
        """Constructor for the CategoriesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Category.from_dictionary(x) for x in dictionary.get('data')]
