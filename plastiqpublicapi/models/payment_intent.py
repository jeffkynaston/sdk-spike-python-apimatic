...
class PaymentIntent(object):
    ...
    """Implementation of the 'PaymentIntent' model.
    ...
    Attributes:
        ...
        status_reasons (list of object): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 created_at=None,
                 expires_at=None):
        """Constructor for the PaymentIntent class"""
    ...
    def from_dictionary(cls,
        ...
        status_reasons = dictionary.get('statusReasons')
        ...
        expires_at = APIHelper.RFC3339DateTime.from_value(dictionary.get("expiresAt")).datetime if dictionary.get("expiresAt") else None
