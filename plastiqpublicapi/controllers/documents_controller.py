...
from plastiqpublicapi.models.document_upload import DocumentUpload
...
class DocumentsController(BaseController):
    ...
    def __init__(self, config, call_back=None):
        super(DocumentsController, self).__init__(config, call_back)
    ...
    def upload_a_document(self,
                          ...
                          end_user_ip=None):
        """Does a POST request to /documents.

        Upload a document

        Args:
            body (CreateDocumentUploadRequest): Document metadata
        ...
        Returns:
            DocumentUpload: Response from the API. Document upload URL
        ...
        decoded = APIHelper.json_deserialize(_response.text, DocumentUpload.from_dictionary)
