...
from plastiqpublicapi.http.requests_client import RequestsClient
...
class Configuration(object):
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: 'https://connect.sandbox.plastiq.com/api'
        },
        Environment.ENVIRONMENT2: {
            Server.DEFAULT: 'https://connect.plastiq.com/api'
        }
    }
